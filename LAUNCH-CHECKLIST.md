...
1. Go to <https://github.com/elysiumui/elysium/actions/runs/28615834679>
...
1. Dash → **Workers & Pages** → **Create** → **Pages** → **Connect to Git** →
   authorize the Cloudflare GitHub app for **elysiumui/elysium** (private repos
   are supported).
...
1. <https://github.com/settings/personal-access-tokens/new> → **Fine-grained
   ...
   `elysiumui/elysium`; Permissions → **Contents: Read-only**. 1-year expiry.
