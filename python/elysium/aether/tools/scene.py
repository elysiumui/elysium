...
@register_tool(
    ...
    input_schema={"type":"object","additionalProperties":False,"properties":{
        "id":{"type":"string"},"operation":{"enum":["extrude","extrude_individual","inset","move","rotate","scale","delete","fill","add_vertex","connect","extrude_vertices","extrude_edges","merge_center"]},
