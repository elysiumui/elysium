...
@register_tool(
    ...
    description='Append a retained Mirror, Array, Solidify, Subdivision or WeightedNormals modifier without changing source geometry. Mirror: axis x/y/z, offset plane coordinate in meters, merge boolean, threshold distance to plane. Array: count 1–64 and absolute local-meter XYZ offset. Solidify: nonzero thickness in meters, offset -1 to 1, rim boolean; simple angle-weighted normals on consistently oriented manifold surfaces, without even-thickness correction or intersection repair. Subdivision: levels 1–4, method catmull-clark or simple, boundary all or keep_corners; discrete levels without limit-surface projection or creases, linear face-varying UV interpolation. WeightedNormals: mode face_area, corner_angle or face_angle; weight integer 1–100; threshold 0–10; keep_sharp boolean. Whole-mesh flat shading is preserved; use Smooth to see weighting. No vertex groups or face-strength influence. Stack order is significant.',
    input_schema={'type':'object','additionalProperties':False,'properties':{'id':{'type':'string'},'kind':{'enum':['Mirror','Array','Solidify','Subdivision','WeightedNormals']},'parameters':{'type':'object'}},'required':['id','kind']},
)
